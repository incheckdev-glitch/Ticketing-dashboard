  ...
  async loadAndRefresh(options = {}) {
    ...
    try {
      const [clientsRes, agreementsRes, invoicesRes, receiptsRes] = await Promise.all([
        Api.postAuthenticatedAllPages('clients', 'list', { limit: 100, sort_by: 'updated_at', sort_dir: 'desc', search: this.state.search || '', summary_only: true }),
        Api.postAuthenticatedAllPages('agreements', 'list', { summary_only: true, limit: 100 }),
        Api.postAuthenticatedAllPages('invoices', 'list', { summary_only: true, limit: 100 }),
        Api.postAuthenticatedAllPages('receipts', 'list', { summary_only: true, limit: 100 })
      ]);
