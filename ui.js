...
function cacheEls() {
  [
   ...
   'aiClustersList',
    ...
    'clientFormDeleteBtn',
    'clientFormClientId',
    'clientFormCustomerName',
    'clientFormCustomerLegalName',
    'clientFormCustomerContactName',
    'clientFormCustomerContactEmail',
    'clientFormCustomerContactMobile',
    'clientFormCompanyPhone',
    'clientFormCompanyAddress',
    'clientFormCountry',
    'clientFormTaxRegistrationNumber',
    'clientFormAccountStatus',
    'clientFormContractTerm',
    'clientFormBillingFrequency',
    'clientFormPaymentTerms',
    'clientFormCurrency',
    'clientFormNotes',
    'agreementFormModal',
    'agreementForm',
